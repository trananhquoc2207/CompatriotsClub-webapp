...
const DeleteEmployeeModal = ({ data, onRefresh, onClose }) => {
  const onSubmit = async () => {
    ...
    const requestData = {
      ...
      additionalLeaderIds: data.scheduleGroup.additionalLeaders[0]?.id ? [data.scheduleGroup.additionalLeaders[0]?.id] : [],
